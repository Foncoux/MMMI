...
std::array<double,NB_PARAM_TOT*NB_CLASSE_AGE> random_search_radius(gsl_rng* random_ptr,std::array<ODE,NB_CLASSE_AGE>& f,const Data &data,int fct_obj_choice,std::array<double,NB_PARAM_TOT*NB_CLASSE_AGE> cond_init);
